public class Aphotheker extends Patient {


    public Aphotheker(int id, String voornaam, String achternaam, int day, int month, int year, int gewicht, int lengte, medicatie medicatie, int dose) {
